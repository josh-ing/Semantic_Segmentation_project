...
from vision.avg_meter import AverageMeter
...
from vision.trainer import DEFAULT_ARGS
from vision.utils import load_class_names, get_imagenet_mean_std, get_logger, normalize_img
from vision.accuracy_calculator import AccuracyCalculator
    ...
    def execute_on_img(self, image: np.ndarray) -> np.ndarray:
        ...
        if is_single_scale:
            ...
            for scale in self.scales:
                ...
                if self.use_gpu:
                    scaled_prediction = scaled_prediction.cuda()
